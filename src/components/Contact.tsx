                    ...
                    <div className="contact__methods">
                        <a href="mailto:alex@developer.com" className="contact-method">
                            ...
                            <div>
                                ...
                                <div className="contact-method__value">alex@developer.com</div>
                            </div>
                        </a>
                        ...
                        <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="contact-method">
                            ...
                            <div>
                                ...
                                <div className="contact-method__value">github.com/alexdev</div>
                            </div>
                        </a>
                        ...
                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="contact-method">
                            ...
                            <div>
                                ...
                                <div className="contact-method__value">linkedin.com/in/alexdev</div>
                            </div>
                        </a>
                        ...
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="contact-method">
                            ...
                            <div>
                                ...
                                <div className="contact-method__value">@alexdev</div>
                            </div>
                        </a>
                    </div>
                </div>
